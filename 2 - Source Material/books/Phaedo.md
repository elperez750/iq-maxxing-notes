...
* That some learning is in fact the recollection of knowledge familiar from a previous existence is 'proved' in this dialogue by the fact that men appear to have clear concepts of equality itself, untainted by the imperfections of any earthly pair of equals
...
##### Essentially, nothing will ever be equal, but since we have the notion of true equality, then that must have come from somewhere else, which is one of Socrates arguments for the soul remaining intact after birth.

##### Again, this doesn't really prove that the soul endures after death. Or that there are souls at all, but if we assume that they, then what is to say that the souls is not created right before birth and then destroyed right after death??
...
##### He argues that that life can only come from the dead, meaning souls of people who died, which is what he argues is the reason for the souls remaining intact and not just disappearing, but this does not answer the question of where they came from? It seems to me more plausible that souls are created, especially since not every person is the same. If the soul is reflected in personality, then the recycled souls argument does not make sense. Just as what he was saying about equality, that true equality does not exist.



## The Argument from Affinity

* The unseen soul when it avoids company of the body, is more like the unchanging and indestructible Ideas than the visible, changing , perishable entities we are familiar with.
* One cannot hope to know what sort a thing is until one has discovered what it is
...
##### Composite things are the physical, the things that change, such as the earth, the weather, the human body. They are prone to rot, decay, erosion


##### Incomposite objects are things that are invisible, constant and never changing, such as beauty and equality, which are universal concepts which can never be destroyed, even if human civilization were to be destroyed by aliens.
...
##### So then by this theory, that means that the human population will eventually decline, since most people participate in actions that he considers will taint the soul. By that logic, these souls will not be reborn which lessens the population.
